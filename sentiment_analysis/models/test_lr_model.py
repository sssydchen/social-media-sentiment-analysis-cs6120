...
"""
    ...
    This class tests the fitting and prediction behavior of the LRModel,
...
class TestLRModel(unittest.TestCase):
    def setUp(self):
        """
        Setup a fresh LRModel instance and some sample data before each test case.

        Inputs:
            None
        Outputs:
            self.model (LRModel): A new LRModel instance ready for testing.
